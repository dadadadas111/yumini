...
class _AuthenWidgetState extends State<AuthenWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Authen'});
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'AUTHEN_PAGE_SIGN_IN_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'AUTHEN_PAGE_FORGOT_PASSWORD_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'AUTHEN_CONTINUE_WITH_GOOGLE_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_auth');
                                                                    GoRouter.of(
                                                                            context)
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'AUTHEN_PAGE_CREATE_ACCOUNT_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
